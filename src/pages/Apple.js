...
import logo from './assets/Apple png.png';
import './item.css';
    ...
    <><form className="m-4" onSubmit={handleSubmit}>
      ...
      <div className="div">
        ...
        <div id="content" className="child">
          <h1> FRESH APPLES</h1>
          <h4>This red fruit with a hard exterior is bejewelled<br />
           with sweet and juicy, ruby-red seeds on<br />
            the inside. Each little seed is <br />
